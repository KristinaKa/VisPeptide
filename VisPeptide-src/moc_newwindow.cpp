...
static const char qt_meta_stringdata_NewWindow[] = {
    "NewWindow\0"
};
...
const QMetaObjectExtraData NewWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NewWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewWindow,
      qt_meta_data_NewWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NewWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewWindow))
